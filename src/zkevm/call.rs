//!
//! Translates the call instructions of the zkEVM Yul extension.
//!
    ...
    D: Dependency,
{
    ...
    context.write_abi_pointer(result_abi_data_pointer, crate::GLOBAL_RETURN_DATA_POINTER);
    context.write_abi_data_size(result_abi_data_pointer, crate::GLOBAL_RETURN_DATA_SIZE);
    ...
    D: Dependency,
{
    ...
    let far_call_result = context
        .build_call(
            function,
            crate::utils::external_call_arguments(context, abi_data, address, vec![], None)
                .as_slice(),
    ...
    D: Dependency,
{
    ...
    let far_call_result = context
        .build_call(
            function,
            crate::utils::external_call_arguments(context, abi_data, address, extra_abi_data, None)
                .as_slice(),
            "system_far_call_external",
        )
        .expect("IntrinsicFunction always returns a flag");
